...
STRINGS: dict[str, dict[str, str]] = {
    ...
    "tab.support":     {"en": "Support", "pl": "Wsparcie", "de": "Support", "fr": "Soutien", "es": "Apoyo", "zh": "支持", "ja": "サポート"},
    "tab.reactive":    {"en": "Reactive", "pl": "Reaktywne", "de": "Reaktiv", "fr": "Réactif", "es": "Reactivo", "zh": "响应", "ja": "リアクティブ"},
    "react.title":     {"en": "React to your machine", "pl": "Reaguj na maszynę", "de": "Auf die Maschine reagieren", "fr": "Réagir à la machine", "es": "Reacciona a tu máquina", "zh": "响应你的机器", "ja": "マシンに反応"},
    "react.temp":      {"en": "🌡️ Temp glow", "pl": "🌡️ Kolor od temperatury", "de": "🌡️ Temp-Glühen", "fr": "🌡️ Lueur temp.", "es": "🌡️ Brillo por temp.", "zh": "🌡️ 温度光效", "ja": "🌡️ 温度グロー"},
    "react.load":      {"en": "📊 CPU load", "pl": "📊 Obciążenie CPU", "de": "📊 CPU-Last", "fr": "📊 Charge CPU", "es": "📊 Carga CPU", "zh": "📊 CPU 负载", "ja": "📊 CPU負荷"},
    "react.ambient":   {"en": "🖥️ Screen ambient", "pl": "🖥️ Kolor z ekranu", "de": "🖥️ Bildschirm-Ambiente", "fr": "🖥️ Ambiance écran", "es": "🖥️ Ambiente pantalla", "zh": "🖥️ 屏幕氛围", "ja": "🖥️ 画面アンビエント"},
    "react.mouse":     {"en": "🖱️ Follow mouse", "pl": "🖱️ Za myszką", "de": "🖱️ Maus folgen", "fr": "🖱️ Suivre la souris", "es": "🖱️ Seguir ratón", "zh": "🖱️ 跟随鼠标", "ja": "🖱️ マウス追従"},
    "set.version":     {"en": "Version", "pl": "Wersja", "de": "Version", "fr": "Version", "es": "Versión", "zh": "版本", "ja": "バージョン"},
    "react.info":      {"en": "Lights react live to temperature, CPU load, or your screen colors.", "pl": "Diody reagują na żywo na temperaturę, obciążenie CPU lub kolory ekranu.", "de": "Lichter reagieren live auf Temperatur, CPU-Last oder Bildschirmfarben.", "fr": "Les LED réagissent en direct à la température, la charge CPU ou l'écran.", "es": "Las luces reaccionan a temperatura, carga de CPU o colores de pantalla.", "zh": "灯光实时响应温度、CPU 负载或屏幕色彩。", "ja": "温度・CPU負荷・画面の色にライトがリアルタイム反応。"},
    "sup.title":       {"en": "Sponsors", "pl": "Sponsorzy", "de": "Sponsoren", "fr": "Sponsors", "es": "Patrocinadores", "zh": "赞助者", "ja": "スポンサー"},
    "sup.creator":     {"en": "Creator · first sponsor", "pl": "Twórca · pierwszy sponsor", "de": "Ersteller · erster Sponsor", "fr": "Créateur · premier sponsor", "es": "Creador · primer patrocinador", "zh": "创作者 · 首位赞助", "ja": "制作者 · 最初のスポンサー"},
    "sup.thanks":      {"en": "Thank you for supporting SteamLEDs 💜", "pl": "Dziękuję za wsparcie SteamLEDs 💜", "de": "Danke für die Unterstützung von SteamLEDs 💜", "fr": "Merci de soutenir SteamLEDs 💜", "es": "Gracias por apoyar SteamLEDs 💜", "zh": "感谢支持 SteamLEDs 💜", "ja": "SteamLEDsへのご支援ありがとう 💜"},
    ...
    "anim.delete":     {"en": "Delete", "pl": "Usuń", "de": "Löschen", "fr": "Supprimer", "es": "Eliminar", "zh": "删除", "ja": "削除"},
