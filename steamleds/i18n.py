...
STRINGS: dict[str, dict[str, str]] = {
    ...
    "sys.fanctl":      {"en": "Fan control is coming (read-only for now, for safety).", "pl": "Sterowanie wiatrakiem wkrótce (na razie tylko odczyt — dla bezpieczeństwa).", "de": "Lüftersteuerung folgt (vorerst nur Lesen — aus Sicherheit).", "fr": "Contrôle du ventilateur à venir (lecture seule pour l'instant).", "es": "Control del ventilador próximamente (solo lectura por seguridad).", "zh": "风扇控制即将推出（目前仅读取，出于安全）。", "ja": "ファン制御は近日対応（安全のため現在は読み取りのみ）。"},
